...
(function (angular) {
    ...
    angular
        ...
        .controller('AnalyzesModalController', AnalyzesModalController);

    AnalyzesModalController.$inject = [
        '$uibModalInstance',
        'threadDump'
    ];
    /* @ngInject */
    function AnalyzesModalController($uibModalInstance, threadDump) {
        var vm = this;
