...
public class MailService {
    ...
    public MailService(AppProperties properties, JavaMailSender javaMailSender,
    ...
    public void sendEmail(String to, String subject, String content, boolean isMultipart, boolean isHtml) {
        ...
        try {
            MimeMessageHelper message = new MimeMessageHelper(mimeMessage, isMultipart, Charset.forName("UTF-8").name());
            message.setTo(to);
