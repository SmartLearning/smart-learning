...
package com.smart.learning.web.filter;
...
public class CachingHttpHeadersFilter implements Filter {
    ...
    public CachingHttpHeadersFilter(AppProperties properties) {
    ...
    public void init(FilterConfig filterConfig) throws ServletException {
        cacheTimeToLive = TimeUnit.DAYS.toMillis(properties.getHttp().getCache().getTimeToLiveInDays());
    }
}
