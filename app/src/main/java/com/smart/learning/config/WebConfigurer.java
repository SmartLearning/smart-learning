...
import com.smart.learning.web.filter.CachingHttpHeadersFilter;
...
public class WebConfigurer implements ServletContextInitializer, EmbeddedServletContainerCustomizer {
    ...
    public WebConfigurer(Environment env, AppProperties properties, HazelcastInstance hazelcastInstance) {
        this.env = env;
    ...
    public void customize(ConfigurableEmbeddedServletContainer container) {
         ...
         * See the AppProperties class and your application-*.yml configuration files
         * for more information.
         */
        if (properties.getHttp().getVersion().equals(AppProperties.Http.Version.V_2_0) &&
    ...
    public void onStartup(ServletContext servletContext) throws ServletException {
        ...
        if (env.acceptsProfiles(Constants.Profile.SPRING_PROFILE_PRODUCTION)) {
